...
public class ConsumerPartAssign {
    public static final Logger logger = LoggerFactory.getLogger(ConsumerPartAssign.class.getName());
    ...
    public static void main(String[] args) {
        ...
        props.setProperty(ConsumerConfig.GROUP_ID_CONFIG, "gx_201");
